...
<body>
  <div id="main">
    ...
    <p>The page at https://radio.focusonthefamily.ca/schedule/broadcasts/YYYY-MM contains a table that has all currently uploaded broadcasts for that month.</p>
